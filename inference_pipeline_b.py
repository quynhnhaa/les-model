#!/usr/bin/env python3
"""
Inference script for Pipeline B - Calculate Dice and Hausdorff metrics on test set
"""
import argparse
import os
import pathlib
...
from src.models.pipeline_b_unet import PipelineB_Unet
...
parser = argparse.ArgumentParser(description='Pipeline B Inference - Calculate Dice and Hausdorff on test set')
...
parser.add_argument('--output_dir', default='./pipeline_b_predictions',
...
def save_results(all_metrics, args):
    ...
    results_file = output_dir / f'pipeline_b_test_results_seed{args.seed}.csv'
    ...
    summary_file = output_dir / f'pipeline_b_test_summary_seed{args.seed}.csv'
    summary.to_csv(summary_file)
    print(f"Saved summary statistics to: {summary_file}")

    # Print summary to console
    print("\n" + "="*60)
    print("PIPELINE B TEST SET RESULTS")
    print("="*60)
...
def main(args):
    ...
    # Create model - Use Pipeline B specific model
    model = PipelineB_Unet(
        4, 3,
